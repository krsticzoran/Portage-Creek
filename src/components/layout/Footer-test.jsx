...
import YourVision from '@/components/layout/YourVision'

export default function Footer() {
  return (
    <>
      <YourVision />
      <footer className="pt-[70px] lg:pt-[120px] pb-9 w-full overflow-hidden dark:bg-primary-dark dark:text-white transition-colors duration-200">
        <Container className="flex flex-col gap-6 lg:gap-[96px]">
          <div className="flex justify-between flex-col lg:flex-row gap-[42px] lg:gap-0">
            <div className="flex flex-col gap-[26px] max-w-[392px]">
              <Image
                ...
                height={70}
                loading="lazy"
                className="object-contain w-[219px] sm:w-[254px] h-auto dark:hidden"
              />
              <Image
                src="/logo3.png"
                alt="Portage Creek Web Designs"
                ...
                height={70}
                loading="lazy"
                className="object-contain w-[219px] sm:w-[254px] h-auto hidden dark:block"
              />
            ...
            <nav
              ...
              className="flex flex-col sm:flex-row gap-6 sm:gap-[64px]"
            >
              <div className="flex flex-col gap-[37px]">
                <p className="font-medium text-xl sm:text-[24px] leading-[100%] tracking-[0]">
                  Quick Links
                </p>
          ...
          <div>
            <div className="border border-black opacity-[0.1] dark:border-white"></div>
